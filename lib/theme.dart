...
class LightModeColors {
  ...
  static const lightOnWarningContainer = Color(0xFFD97706);
  ...
  static const secondaryGradientStart = Color(0xFF8B5CF6);
  static const secondaryGradientEnd = Color(0xFF7C3AED);
  static const successGradientStart = Color(0xFF34D399);
  static const successGradientEnd = Color(0xFF059669);
  static const warningGradientStart = Color(0xFFFBBF24);
  static const warningGradientEnd = Color(0xFFF59E0B);
  static const errorGradientStart = Color(0xFFF87171);
  static const errorGradientEnd = Color(0xFFEF4444);
}
...
class DarkModeColors {
  ...
  static const darkOnWarning = Color(0xFF78350F);
  static const darkWarningContainer = Color(0xFFD97706);
  static const darkOnWarningContainer = Color(0xFFFEF3C7);
  static const darkSuccess = Color(0xFF10B981);
  static const darkOnSuccess = Color(0xFF022C22);
  static const darkSuccessContainer = Color(0xFF047857);
  static const darkOnSuccessContainer = Color(0xFFD1FAE5);
  ...
  // Gradient colors
  static const primaryGradientStart = Color(0xFF3B82F6);
  static const primaryGradientEnd = Color(0xFF1E40AF);
  static const secondaryGradientStart = Color(0xFFA855F7);
  static const secondaryGradientEnd = Color(0xFF7C3AED);
  static const successGradientStart = Color(0xFF10B981);
  static const successGradientEnd = Color(0xFF047857);
  static const warningGradientStart = Color(0xFFF59E0B);
  static const warningGradientEnd = Color(0xFFD97706);
  static const errorGradientStart = Color(0xFFEF4444);
  static const errorGradientEnd = Color(0xFFDC2626);
}
